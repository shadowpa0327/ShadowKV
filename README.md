...
# ShadowKV
OMP_NUM_THREADS=48 torchrun --standalone --nnodes=1 --nproc_per_node 8 test/eval_acc.py --datalen 65536 --method shadowkv --dataset_name "ruler/niah_single_1" --sparse_budget 2048 --rank 160 --chunk_size 8
```
